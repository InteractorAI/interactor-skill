...
There is no separate endpoint to upload an image, so you must do it via patch schema as described above. Before preparing the patch, read `references/patching-behavior.md`.
